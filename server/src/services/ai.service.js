...
2. Never invent skills, experience, education, projects, certifications, or achievements.
3. Identify skills explicitly present in the resume that are relevant to the job description.
4. Identify important job-description keywords that are missing or not clearly demonstrated in the resume.
5. Do not mark a keyword as missing if the resume clearly demonstrates the same skill using equivalent wording.
6. Evaluate experience based only on evidence in the resume.
7. Evaluate projects based only on projects actually present in the resume.
...
12. Do not calculate a final ATS score. The backend will calculate it.
